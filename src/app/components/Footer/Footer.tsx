...
export const Footer = () => {
  return (
    <footer className="bg-green-600">
      <div className="mx-auto w-full max-w-screen-xl">
        <div className="grid grid-cols-1 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
          <div className="p-5 md:p-0">
            <h2 className="mb-6 text-sm font-semibold text-white uppercase flex flex-row items-center gap-3 ">
      ...
      <div className="px-4 py-4 w-100 bg-green-700  md:flex md:items-center md:justify-around">
